...
Elm.StripeCheckout = Elm.StripeCheckout || {};
Elm.StripeCheckout.make = function (_elm) {
   "use strict";
   _elm.StripeCheckout = _elm.StripeCheckout || {};
   if (_elm.StripeCheckout.values)
   return _elm.StripeCheckout.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "StripeCheckout",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var checkout = A3($Html.node,
   "script",
   A2($List.map,
   $Basics.uncurry($Html$Attributes.attribute),
   _L.fromArray([{ctor: "_Tuple2"
                 ,_0: "src"
                 ,_1: "https://checkout.stripe.com/checkout.js"}
                ,{ctor: "_Tuple2"
                 ,_0: "class"
                 ,_1: "stripe-button"}
                ,{ctor: "_Tuple2"
                 ,_0: "data-key"
                 ,_1: "pk_test_Y31x7Mqyi1iY63IQb95IAORm"}
                ,{ctor: "_Tuple2"
                 ,_0: "data-name"
                 ,_1: "nicklawls.github.io"}
                ,{ctor: "_Tuple2"
                 ,_0: "data-description"
                 ,_1: "2 widgets"}
                ,{ctor: "_Tuple2"
                ...
                ,{ctor: "_Tuple2"
                 ...
                 ,_1: "auto"}])),
   _L.fromArray([]));
   var checkoutForm = A2($Html.form,
   _L.fromArray([$Html$Attributes.action("http://localhost:8081/charges")
                ,$Html$Attributes.method("POST")]),
   _L.fromArray([checkout]));
   var main = checkoutForm;
   _elm.StripeCheckout.values = {_op: _op
                                ,checkout: checkout
